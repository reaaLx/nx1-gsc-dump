...
main( model, type )
{
	build_template( "stryker50cal_turrettrophy", model, type );
...
/*QUAKED script_vehicle_stryker50cal_turrettrophy (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER


maps\_stryker50cal_turrettrophy::main( "vehicle_stryker_config2" );


include,vehicle_stryker50cal_turrettrophy
sound,vehicle_stryker,vehicle_standard,all_sp


defaultmdl="vehicle_stryker_config2"
default:"vehicletype" "stryker50cal_turrettrophy"
