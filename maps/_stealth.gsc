...
main()
{
	...
	level._global_callbacks[ "_autosave_stealthcheck" ] 		= ::_autosave_stealthcheck;
	level._global_callbacks[ "_patrol_endon_spotted_flag" ] 	= ::_patrol_endon_spotted_flag;	
	level._global_callbacks[ "_spawner_stealth_default" ] 	= ::_spawner_stealth_default;	
